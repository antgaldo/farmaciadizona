	...
	<section class="hero">
		<div class="card-home">
		  <div class="card-body-home">
		    <h5 class="card-title">Stanco di girare a vuoto alla ricerca del farmaco ?</h5>
			...
			<form class="form-home" id="searchfarmaco"  action="searchfarmaco" role="search" method="GET">
			  <div class="flex pos-relative col-md-6">
			    <input class="form-control" type="text" id="cap" placeholder="Cap" name="cap" aria-label="Cap"/>
			    <div class="invalidinput displaynone">Il cap non è valido</div>
			  </div>
			  <div class="flex pos-relative col-md-6">
			    <input class="form-control" id="farmaco" required type="text" placeholder="Farmaco" name="farmaco" aria-label="Farmaco" oninput="isExistFarmaco()"/>
